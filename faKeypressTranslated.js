...
function setLanguage(lang) {
    if (lang === "en" || lang === "el") {
        ...
        var langCookie = $.cookie(cookieName + "_lang");
...
function addTable() {
    ...
    $("#contentContainer h3")
        ...
        .after($(
            ...
            "</td><td align='center'>"+ String.fromCharCode(keycodes.left)+ "</td><td align='center'>"+ String.fromCharCode(keycodes.right) +"</td></tr></tbody></table></div>"));
